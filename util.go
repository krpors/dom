...
// isNameString is shamelessly copied from the encodin/xml package from the
// xml.go file. It actually checks whether a given string s is a valid name
// in XML land. See the XML spec at https://www.w3.org/TR/xml/#NT-Name for
// the valid structure for names.
//
// In short, it checks 'first' for valid ranges of the first character an
// XML name MUST start with. Then it checks ('first' | 'second') for the rest
// of the XML name to check whether it's valid.
//
// XXX: https://www.w3.org/TR/xml/#CharClasses. The list the Go team used
// has been orphaned since 2006 in favor of https://www.w3.org/TR/xml/#NT-Name.
